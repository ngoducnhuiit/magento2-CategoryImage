...
namespace Magepow\CategoryImage\Controller\Adminhtml\Category\Image;
  ...
  */
  class Upload extends \Magento\Backend\App\Action
  {
    ...
    */
    ...
    { 
      return $this->_authorization->isAllowed('Magepow_CategoryImage::category');
    }
    ...
    */
    ...
    {
      try {
        $result = $this->imageUploader->saveFileToTmpDir('magepow_image');
